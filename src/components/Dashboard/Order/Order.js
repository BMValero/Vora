			...
			<Fragment>
				...
				<div className="form-head d-flex mb-3 mb-md-5 align-items-start">
					<div className="mr-auto d-none d-lg-block">
						<Link href="#" className="text-primary d-flex align-items-center mb-3 font-w500" >
						...
						<Link href="#" className="mb-0 text-black font-w500" >Orders  /</Link >
						<Link href="#" className="mb-0 font-w500" > Order Detaills </Link >
					</div>
					<div className="dropdown ml-auto">
						...
						<div className="dropdown-menu dropdown-menu-left">
							<Link href="#" className="dropdown-item" >A To Z List</Link >
							<Link href="#" className="dropdown-item" >Z To A List</Link >
						</div>
					</div>
				</div>
				<div className="row">
									...
									<div className="widget-timeline-icon">
										<ul className="timeline">
											<li>
												...
												<Link href="#" className="timeline-panel text-muted" >
												...
												<tr>
													<td>
														<div className="media">
															...
															<div className="media-body">
																<small className="mt-0 mb-1 font-w500"><Link href="#" className="text-primary" >MAIN COURSE</Link ></small>
																<h5 className="mt-0 mb-2 mb-4"><Link href="/ecom-product-detail" className="text-black" >Watermelon juice with ice</Link ></h5>
													...
													<td>
														<Link href="#"  className="ti-close fs-28 text-danger las la-times-circle"></Link >
													</td>
												</tr>
												<tr>
													<td>
														<div className="media">
															...
															<div className="media-body">
																<small className="mt-0 mb-1 font-w500"><Link href="#" className="text-primary" >MAIN COURSE</Link ></small>
																<h5 className="mt-0 mb-2 text-black mb-4"><Link href="/ecom-product-detail" className="text-black" >Chicken curry special with cucumber</Link ></h5>
																<div className="star-review fs-14">
																	<i className="fa fa-star text-orange"></i>
																	<i className="fa fa-star text-orange"></i>
																	<i className="fa fa-star text-orange"></i>
												...
												<tr>
													<td>
														<div className="media">
															...
															<div className="media-body">
																<small className="mt-0 mb-1 font-w500"><Link href="#" className="text-primary" >MAIN COURSE</Link ></small>
																<h5 className="mt-0 mb-2 text-black mb-4"><Link href="/ecom-product-detail" className="text-black" >Italiano pizza with garlic</Link ></h5>
																<div className="star-review fs-14">
																	<i className="fa fa-star text-orange"></i>
																	<i className="fa fa-star text-orange"></i>
																	<i className="fa fa-star text-orange"></i>
