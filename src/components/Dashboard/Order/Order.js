      ...
      <Fragment>
        <div className="form-head d-flex mb-3 mb-md-5 align-items-start">
          <div className="mr-auto d-none d-lg-block">
            <Link
              href="#"
              className="text-primary d-flex align-items-center mb-3 font-w500"
            >
              <svg
                className="mr-3"
                width="24"
            ...
            <h3 className="text-black font-w600 mb-0 fs-22 mb-2">
              Order ID #5552351
            </h3>
            <Link href="#" className="mb-0 text-black font-w500">
              Orders /
            </Link>
            <Link href="#" className="mb-0 font-w500">
              {" "}
              Order Detaills{" "}
            </Link>
          </div>
                    ...
                    <div className="row mx-0 align-items-center">
                      <div className="media align-items-center col-xl-6 col-lg-5 px-0 mb-3 mb-md-0">
                        <Image
                          ...
                          src={
                            require("../../../../images/profile/5.png").default
                          }
                          alt="DexignZone"
                        />
                        <div className="media-body">
                          <p className="text-white mb-1 wspace-no">
                            Delivery guy
                          </p>
                          <h3 className="mb-1 text-white  fs-22">
                            Rainold Hawkins
                          </h3>
                          <small className="text-gray wspace-no">
                            ID 412455
                          </small>
                        </div>
                      </div>
                  ...
                  <div className="card-body border-bottom">
                    <div className="media align-items-center">
                      ...
                      <div className="media-body">
                        ...
                        <span className="bgl-info fs-14 text-info p-2 rounded">
                          Customer
                        </span>
                      </div>
                    </div>
              ...
              <div className="col-xl-12 col-md-6 col-xxl-6">
                <div className="card">
                  <div className="card-header border-0">
                    <h4 className="text-black font-w600 wspace-no">
                      Customer Favourite
                    </h4>
                  </div>
