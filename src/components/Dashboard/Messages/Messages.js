        ...
        <div className="media mb-4" key="index">
          <div className="image-bx">
            <Image
              ...
              height={60}
              alt=""
              className="rounded-circle mr-sm-4 mr-2 img-1"
            />
          </div>
                ...
                <div className="card">
                  <div className="card-body d-sm-flex d-block align-items-center">
                    <div className="d-flex mr-auto mb-sm-0 mb-2 align-items-center">
                      ...
                      />
                      <div>
                        <h5 className="fs-18 text-black font-w600">
                          Peter Parkur
                        </h5>
                        <Dropdown>
                          ...
                          <Dropdown.Menu className="dropdown-menu-right">
                            <Dropdown.Item href="#">Available</Dropdown.Item>
                            <Dropdown.Item href="#">Unavailable</Dropdown.Item>
                          </Dropdown.Menu>
                        </Dropdown>
                      </div>
                    </div>
                    ...
                    >
                      <i className="las la-comment-dots mr-2 scale5"></i>+ New
                    </Link>
                  </div>
                </div>
              </div>
              <div className="col-xl-12">
                <div className="card">
                  ...
                  >
                    ...
                    <PerfectScrollbar
                      className="card-body message-bx dlab-scroll height520"
                      id="message-bx"
                    >
                      <Tab.Content>
                        {tabData.map(
            ...
            <div className="row">
              <div className="col-xl-12">
                <div className="card  message-bx chat-box">
                  ...
                  <PerfectScrollbar
                    className="card-body dlab-scroll height640"
                    id="chartBox"
                  >
                    ...
                    <div className="media justify-content-start align-items-start">
                      ...
                      <div className="message-received">
                        <p className="mb-1">
                          Hey, check my design update last night. Tell me what
                          you think and if that is OK. I hear client said they
                          want to change the layout concept
                        </p>
                        <span className="fs-12">4.30 AM</span>
                      </div>
                    </div>
                  ...
                  <div className="card-footer border-0 type-massage">
                    <div className="input-group">
                      ...
                      <div className="input-group-append">
                        <button type="button" className="btn shadow-none pr-0">
                          <i className="las la-paperclip scale5"></i>
                        </button>
                        <button type="button" className="btn shadow-none">
                          <i className="las la-image scale5"></i>
                        </button>
                        <button
                          type="button"
                          className="btn btn-primary light rounded"
                        >
                          SEND
                        </button>
                      </div>
