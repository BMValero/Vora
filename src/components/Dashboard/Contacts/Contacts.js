							...
							<div className="card-body">
								<div className="media">
									<div className="image-bx mr-3">
										<img src={item.image.src} alt="" className="rounded-circle" width="90" / >
										<span className="active"></span>
									</div>
									<div className="media-body">
										<h6 className="fs-20 font-w600 mb-0"><Link href="/app-profile" className="text-black">{item.name}</Link></h6>
										<p className="fs-14">Highspeed Inc.</p>
										<ul>
											<li><Link href="#"><i className="fa fa-phone" aria-hidden="true"></i></Link></li>
											<li><Link href="#"><i className="fa fa-video-camera" aria-hidden="true"></i></Link></li>
											<li><Link href="/messages"><i className="las la-sms"></i></Link></li>
										</ul>
									</div>
								</div>
							</div>
			...
			<Fragment>
				<Tab.Container defaultActiveKey={tabData[0].name.toLowerCase()}>
					<div className="d-md-flex d-block mb-3 pb-3 border-bottom">
						...
						<div>
							<Link href="#" onClick={this.handleShow} data-toggle="modal" data-target="#addOrderModal"  className="btn btn-primary rounded"><i className="fa fa-user mr-2 scale5" aria-hidden="true"></i>+ New Contact</Link>
								...
								<Tab.Content >
									...
									<div className="row">
										<div className="col-xl-12 mb-4 text-center">
											<Link  className="btn btn-outline-primary mx-auto dlab-load-more"  href="#" id="RecentActivities">Load More</Link>
										</div>
									</div>
								</div>
							</div>
									...
									<div className="card profile-card">
										<div className="card-body pb-0 text-center">
											<div className="image-bx mb-3">
												<img src={user25.src} alt="" width="120" className="rounded-circle" />
												<span className="active"></span>
											</div>
											<h4 className="fs-20 mb-0"><Link href="/app-profile" className="text-black">Angela Moss</Link></h4>
											<p className="fs-14">Highspeed Inc.</p>
											<ul>
												<li><Link href="#"><i className="fa fa-phone" aria-hidden="true"></i></Link></li>
												<li><Link href="#"><i className="fa fa-video-camera" aria-hidden="true"></i></Link></li>
											...
											<div className="row">
												<div className="col-6">
													<Link href="/app-profile" className="btn btn-sm btn-outline-primary rounded d-block">Edit</Link>
												</div>
												<div className="col-6">
													<Link href="/app-profile" className="btn btn-sm btn-outline-dark rounded d-block">Remove</Link>
												</div>
											</div>
										</div>
										<div className="card-body">
