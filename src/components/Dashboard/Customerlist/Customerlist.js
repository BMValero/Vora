  ...
  const data = {
    ...
    rows: [
		{	check: <div className="sorting_1 p-0 text-center">
			...
			status: <Link href="#" className="btn bgl-light text-black btn-sm">$14.89</Link>,
		...
		},
		{
			...
			status: <Link href="#" className="btn bgl-light text-black btn-sm">$8.13</Link>,
			dropdown: <Dropdownblog1 />,
		},
		{
			check: 
			...
			status: <Link href="#" className="btn bgl-light text-black btn-sm">$21.55</Link>,
			dropdown: <Dropdownblog1 />,
		},
		{
			check: 
			...
			status: <Link href="#" className="btn bgl-light text-black btn-sm">$42.85</Link>,
			dropdown: <Dropdownblog1 />,
		},
		{
			check: 
			...
			status: <Link href="#" className="btn bgl-light text-black btn-sm">$11.41</Link>,
			dropdown: <Dropdownblog1 />,
		},
		{
			check: 
			...
			status: <Link href="#" className="btn bgl-light text-black btn-sm">$67.27</Link>,
			dropdown: <Dropdownblog1 />,
		},
		{
			check: 
		...
		},
		{
			...
			status: <Link href="#" className="btn bgl-light text-black btn-sm">$91.68</Link>,
			dropdown: <Dropdownblog1 />,
		},
		{
			check: 
