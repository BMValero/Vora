									  ...
									  <tr key={i}>
										<td>
											<div>
												...
												<h4 className="title font-w600 mb-2"><Link href="/post-details" className="text-black">{d.title}</Link></h4>
										...
										<td>
										{ (d.act === "Process") ? (
												  <Link href="#" className="btn btn-info d-block rounded"> {d.act} </Link>
										) : (d.act === "Closed") ? (
												  <Link href="#"  className="btn btn-danger d-block rounded"> {d.act} </Link>
										) : (d.act === "Pending") ? (
												  <Link href="#"  className="btn btn-warning d-block rounded"> {d.act} </Link>
										) : ('')}
							 ...
							 <div className="d-flex justify-content-between align-items-center mt-3">
								...
								<div className="dataTables_paginate paging_simple_numbers">
								   <Pagination size="lg" >
									  ...
									  >
										{/* <Link className="page-link" href="#">  <i className="la la-angle-left" /></Link> */}
										<Link className="paginate_button previous" href="#"> Previous</Link>
									  </li>
									  ...
									  >
										{/* <Link className="page-link" href="#"><i className="la la-angle-right" /></Link> */}
										<Link className="paginate_button next" href="#"> Next</Link>
									  </li>
								   </Pagination>
								</div>
							 </div>
