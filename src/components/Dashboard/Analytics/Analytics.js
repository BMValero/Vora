...
const sampleData1 = [
  5, 6, 4, 3, 4, 3, 4, 3, 6, 5, 6, 4, 5, 2, 3, 4, 2, 1, 5, 3,
];
const sampleData2 = [
  8, 5, 3, 1, 2, 4, 5, 7, 3, 4, 6, 2, 4, 6, 7, 6, 3, 4, 5, 3,
];
const sampleData3 = [
  6, 5, 2, 5, 4, 7, 8, 7, 6, 5, 6, 4, 3, 4, 3, 4, 3, 6, 7, 6,
];
const tabData = [
                      ...
                      <div className="chart-deta d-inline-block">
                        <div className="col px-0">
                          ...
                          <div>
                            ...
                            <small className="font-w500 fs-14 text-muted">
                              Menu Sold
                            </small>
                          </div>
                        </div>
                        ...
                        <div className="col px-0">
                          ...
                          <div>
                            <h4 className="text-black fs-20 font-w600 mb-1">
                              $97,126
                            </h4>
                            <small className="font-w500 fs-14 text-muted">
                              Safe(20%)
                  ...
                  <div className="media align-items-center mb-4">
                    ...
                    <div className="media-body">
                      <h5 className="text-black">
                        <Link href="/app-profile" className="text-black">
                          Alexzander Queqe
                        </Link>
                      </h5>
          ...
          <div className="row">
            ...
            <div className="col-xl-12 col-xxl-6 col-md-6">
              <div className="card">
                ...
                <div className="card-footer border-0 text-center">
                  <Link href="/ecom-product-list" className="btn-link">
                    View More &gt;&gt;
                  </Link>
                </div>
              </div>
