      ...
      <div className="card draggable-handle draggable">
        <div className="card-body">
          <div className="border-bottom pb-4">
            <Link href="#" className="btn btn-sm btn-success rounded-xl mb-2">
              Graphic Deisgner
            </Link>
            ...
            <div className="row justify-content-between">
              <ul className="users col-6">
                <li>
                  <Image src={user1.src} width={35} height={35} alt="" />
                </li>
                <li>
                  <Image src={user2.src} width={35} height={35} alt="" />
                </li>
                <li>
                  <Image src={user3.src} width={35} height={35} alt="" />
                </li>
                <li>
                  <Image src={user4.src} width={35} height={35} alt="" />
                </li>
              </ul>
  ...
  return (
    <>
      <div className="card draggable-handle draggable">
        <div className="card-body">
          <div className="border-bottom pb-4">
            <Link href="#" className="btn btn-sm btn-secondary rounded-xl mb-2">
              Digital Marketing
            </Link>
            <p className="font-w600">
              <Link href="/post-details" className="text-black">
            ...
            <div className="row justify-content-between">
              <ul className="users col-6">
                <li>
                  <Image width={35} height={35} src={user5.src} alt="" />
                </li>
                <li>
                  <Image width={35} height={35} src={user6.src} alt="" />
                </li>
                <li>
                  <Image width={35} height={35} src={user7.src} alt="" />
                </li>
                <li>
                  <Image width={35} height={35} src={user8.src} alt="" />
                </li>
              </ul>
              <div className="col-6 pl-0">
                <h6 className="fs-14">
      ...
      <div className="card draggable-handle draggable">
        <div className="card-body">
          <div className="border-bottom pb-">
            <Link href="#" className="btn btn-sm btn-warning rounded-xl mb-2">
              Programmer
            </Link>
            <p className="font-w600">
              <Link href="/post-details" className="text-black">
            ...
            <div className="row justify-content-between">
              <ul className="users col-6">
                <li>
                  <Image width={35} height={35} src={user9.src} alt="" />
                </li>
                <li>
                  <Image width={35} height={35} src={user10.src} alt="" />
                </li>
                <li>
                  <Image width={35} height={35} src={user11.src} alt="" />
                </li>
                <li>
                  <Image width={35} height={35} src={user12.src} alt="" />
                </li>
              </ul>
              <div className="col-6 pl-0">
                <h6 className="fs-14">
  ...
  return (
    <>
      <div className="card draggable-handle draggable">
        <div className="card-body">
          <div className="border-bottom pb-4">
            <Link href="#" className="btn btn-sm btn-info rounded-xl mb-2">
              UX Writer
            </Link>
            <p className="font-w600">
              <Link href="post-details" className="text-black">
            ...
            <div className="row justify-content-between">
              <ul className="users col-6">
                <li>
                  <Image width={35} height={35} src={user1.src} alt="" />
                </li>
                <li>
                  <Image width={35} height={35} src={user2.src} alt="" />
                </li>
                <li>
                  <Image width={35} height={35} src={user3.src} alt="" />
                </li>
                <li>
                  <Image width={35} height={35} src={user4.src} alt="" />
                </li>
              </ul>
              <div className="col-6 pl-0">
                <h6 className="fs-14">
