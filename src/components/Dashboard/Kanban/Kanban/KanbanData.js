	...
	return(
		<>
			...
			<div className="card-header shadow-sm">
				...
				<Link href="/contacts" className="plus-icon"><i className="fa fa-plus" aria-hidden="true"></i></Link>
			</div>
		</>
	)
}
			...
			<div className="card draggable-handle draggable">
				<div className="card-body">
					<div className="border-bottom pb-4">
						<Link href="#" className="btn btn-sm btn-success rounded-xl mb-2">Graphic Deisgner</Link>
						<p className="font-w600"><Link href="/post-details" className="text-black">Visual Graphic for Presentation to Client</Link></p>
						<div className="row justify-content-between">
							<ul className="users col-6">
								<li><img src={user1.src} alt="" /></li>
								<li><img src={user2.src} alt="" /></li>
								<li><img src={user3.src} alt="" /></li>
								<li><img src={user4.src} alt="" /></li>
							</ul>
	...
	return(
		<>
			<div className="card draggable-handle draggable">
				<div className="card-body">
					<div className="border-bottom pb-4">
						<Link href="#" className="btn btn-sm btn-secondary rounded-xl mb-2">Digital Marketing</Link>
						<p className="font-w600"><Link href="/post-details" className="text-black">Build Database Design for Fasto Admin v2</Link></p>
						<div className="row justify-content-between">
							<ul className="users col-6">
								<li><img src={user5.src} alt="" /></li>
								<li><img src={user6.src} alt="" /></li>
								<li><img src={user7.src} alt="" /></li>
								<li><img src={user8.src} alt="" /></li>
							</ul>
							<div className="col-6 pl-0">
								<h6 className="fs-14">Progress
			...
			<div className="card draggable-handle draggable">
				<div className="card-body">
					<div className="border-bottom pb-">
						<Link href="#" className="btn btn-sm btn-warning rounded-xl mb-2">Programmer</Link>
						<p className="font-w600"><Link href="/post-details" className="text-black">Make Promotional Ads for Instagram Fasto’s</Link></p>
						<div className="row justify-content-between">
							<ul className="users col-6">
								<li><img src={user9.src}  alt="" /></li>
								<li><img src={user10.src} alt="" /></li>
								<li><img src={user11.src} alt="" /></li>
								<li><img src={user12.src} alt="" /></li>
							</ul>
							<div className="col-6 pl-0">
								<h6 className="fs-14">Progress
	...
	return(
		<>
			<div className="card draggable-handle draggable">
				<div className="card-body">
					<div className="border-bottom pb-4">
						<Link href="#" className="btn btn-sm btn-info rounded-xl mb-2">UX Writer</Link>
						<p className="font-w600"><Link href="post-details" className="text-black">Caption description for onboarding screens</Link></p>
						<div className="row justify-content-between">
							<ul className="users col-6">
								<li><img src={user1.src} alt="" /></li>
								<li><img src={user2.src} alt="" /></li>
	...
	return(
		<Dropdown>
			<Dropdown.Toggle variant="" as="div" className="i-false" >	
				<Link href="#" data-toggle="dropdown" aria-expanded="false">
